function [ray, tof, theta_min] = ray_bending(P, x_start, z_start, x_target, z_target, to_layer)

    % cost fun
    cost_fun = @(theta) rt.ray_bending_tof(P, theta, x_start, z_start, x_target, z_target, to_layer);

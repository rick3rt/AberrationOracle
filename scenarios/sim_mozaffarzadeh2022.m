...
%   Mozaffarzadeh, M., Verschuur, E., Verweij, M. D., Daeichin, V., De Jong, N.,
%   & Renaud, G. (2022). Refraction-Corrected Transcranial Ultrasound Imaging
%   Through the Human Temporal Window Using a Single Probe. IEEE Transactions
%   on Ultrasonics, Ferroelectrics, and Frequency Control, 69(4),
%   1191–1203. https://doi.org/10.1109/TUFFC.2022.3148121

CASE_NAME = 'Mozaffarzadeh2022';
...
% define transducer
P.lens_thickness = 1.236e-3; % see 10.1109/TUFFC.2024.3445131
P.num_elements = 96;
P.pitch = 0.295e-3;

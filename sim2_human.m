...
bone_curvature = 0.5; % 1/m

P.medium_interfaces = ...
    {P.lens_thickness,
 [bone_curvature, 0.06, P.lens_thickness + dist_trans_bone],
 [bone_curvature, 0.065, P.lens_thickness + dist_trans_bone + bone_thickness]};
